...
let pageNum = function(num){
		console.log(num)
	var url = "adminAttentionList?page="+num+"&size=10"; 
				...
				<div class="tab-pane is-active" id="tab1">
					...
					<div class="board-area list">
						<div class="article-info">
							...
							<div class="right">
							<button class = "modiB" onclick="location.href='adminAttentionWrite'" style="width: 105px;">글쓰기</button>
							</div>
						</div>
...
<%-- 									</c:if> --%>
<%-- 										<c:if test="${attention.notice == false }"> --%>
<%-- 										<input type="checkbox" onclick="noticeornot('${attention.seq}')"> --%>
<%-- 									</c:if> --%>
<!-- 									</td> -->
									<td style="width: 15%;"><button class="modiB" onclick="location.href='adminAttentionModify?seq=${attention.seq }'; return false;">수정</button></td>	
									</tr>
								</c:forEach>
							</tbody>
							<tbody>
