...
function deleted(){
	...
	if(msg = true){
	location.href='attentionDelete?seq=${attention.seq }'
	}
}
		...
		<div class="notification">
			...
			<div class="board-area view">
            	...
            	<div class="board-bottom">
                	...
                	<button type="button" style="width: 300px; margin-right: 10px;" class = "modiA" onclick = "location.href='attentionList?page=0&size=10'">리스트로 가기</button>                		
