					...
					<div class="tab-pane is-active">
						<ul class="nav-tabs type2">
							...
							<li class="is-active"><a
								href="searchEcoReservationf799.html?deptId=B971002">북한산</a></li>


							<li class=""><a
								href="searchEcoReservation2085.html?deptId=B014003">지리산</a></li>


							<li class=""><a
								href="searchEcoReservatione8e6.html?deptId=B123002">소백산</a></li>


							<li class=""><a
								href="searchEcoReservation759b.html?deptId=B301002">설악산</a></li>


							<li class=""><a
								href="searchEcoReservationb1c9.html?deptId=B024002">한려해상</a></li>


							<li class=""><a
								href="searchEcoReservation462e.html?deptId=B231002">무등산</a></li>


							<li class=""><a
								href="searchEcoReservation7676.html?deptId=B133002">가야산</a></li>


							<li class=""><a
								href="searchEcoReservation1a0c.html?deptId=B331001">내장산</a></li>
								...
								<div class="tab-pane is-active">
									...
									<div class="box-guide">
										<div class="monthly-check">
											<strong class="title">생태여행 관련하여 전체 월별 잔여현황을 우측 버튼을
												눌러 확인 가능 합니다.</strong> <a
												href="searchEcoMonthReservationf799.html?deptId=B971002"
												class="btn btn-monthly">월별 잔여현황 확인</a>
										</div>
										<ul class="dot-list">
											<li>본 시설은 생태체험종합시설로서 프로그램 참여, 환경교육등을 위한 강당 및 강의실 예약시에만
												생활관 대관이 가능합니다.</li>
											<li>프로그램은 최소 2명이상 선택하셔야 대관이 가능합니다.</li>

											<li>생활관 잔여객실이 남아있으나 프로그램이 모두 예약불가로 표출되어 예약이 진행되지 않는 경우,
												02-901-0700(주간)으로 문의 바랍니다.</li>
											<li>서울특별시 코로나19 현황 주소 : <a
									...
									<div class="detail-info">
										...
										<dl>
											...
											<dd class="form">
												...
												</span> <span class="copy">※ 단체 선택 시 마이페이지에서 추가정보 입력 후 세금계산서
													발행 신청 가능합니다.</span>
											</dd>
										</dl>
									</div>
										...
										<div class="title-area">
											...
											<div class="btn-area">
												<button type="button" class="btn btn-view"
													onclick="funcArray.drawImage('06004');">프로그램 보기</button>
												<button type="button" class="btn btn-charge"
													onclick="openPopup('programAmtPop');">요금표</button>
										...
										<div class="a">
											...
											<div class="border-box quantity-wrap">
												<dl>
													...
													<dd class="form">
														<div class="row">
															<span class="label">청소년 이하</span> <span
																class="quantity-input">
																<button type="button" class="btn minus program-minus">
																	<i class="icon-minus"></i>
																</button> <label for="programChildCnt" class="hidden-text">청소년이하참여인원</label>
														...
														<div class="row">
															<span class="label">성인</span> <span
																class="quantity-input">
																<button type="button" class="btn minus program-minus">
																	<i class="icon-minus"></i>
																</button> <label for="programAdultCnt" class="hidden-text">성인참여인원</label>
																<input type="number" value="0" readonly
											...
											<ul class="dot-list">
												...
												<li>원활한 프로그램 진행을 위해 10세 이하의 청소년이 참가하는 경우 보호자 1인도 함께 참여
													부탁드립니다.</li>
											</ul>
									...
									<div class="collapse-wrap">
										<div class="title-area">
											...
											<div class="btn-area">
												<button type="button" class="btn btn-view"
													onclick="funcArray.drawImage('06003');">강당 보기</button>
												<button type="button" class="btn btn-charge"
													onclick="openPopup('gangdangAmtPop');">요금표</button>
												<span class="checkbox-1"> <input type="checkbox"
										...
										<div class="a">
													...
													<dd class="form">
														<span class="quantity-input">
															<button type="button"
																...
																<i class="icon-minus"></i>
															</button> <label for="gangDangPrsnCnt" class="hidden-text">총참여인원</label>
											...
											<ul class="dot-list">
												<li>사용인원은 이용요금과 상관이 없습니다. 규모에 맞는 강당 배정을 위해 예상 사용인원을
													입력바랍니다.</li>
											</ul>
									...
									<div class="collapse-wrap">
										<div class="title-area">
											...
											<div class="btn-area">
												<button type="button" class="btn btn-view"
													onclick="funcArray.drawImage('06002');">강의실 보기</button>
												<button type="button" class="btn btn-charge"
													onclick="openPopup('classAmtPop');">요금표</button>
												<span class="checkbox-1"> <input type="checkbox"
													id="check4" class="check collapse" value="class"> <label
													for="check4">옵션 추가예약</label>
												</span>
											</div>
										</div>
										<div class="a">
													...
													<dd class="form">
														<span class="quantity-input">
															<button type="button" class="btn minus class-prsn-minus">
																<i class="icon-minus"></i>
															</button> <label for="classPrsnCnt" class="hidden-text">총참여인원</label>
															<input type="number" value="1" readonly title="총 참여 인원"
											...
											<ul class="dot-list">
												<li>사용인원은 이용요금과 상관이 없습니다. 규모에 맞는 강의실 배정을 위해 예상 사용인원을
													입력바랍니다.</li>
											</ul>
									...
									<div class="board-bottom">
										<div class="center">
											<a href="javascript:void(0);"
												...
												onclick="funcArray.reserStart(); return false;">예약하기</a>
										</div>
									</div>
								</div>
							</div>
					...
					<div class="popup-container">
						...
						<div class="btn-area">
							<button type="button" class="btn btn-confirm is-active"
								onclick="closePopup('mealPop');">확인</button>
						</div>
					</div>
				</div>
			</div>
			...
			<div class="modal-popup large" id="programAmtPop">
				<div class="popup-wrap">
					...
					<div class="popup-container">
						...
						<div class="btn-area">
							<button type="button" class="btn btn-confirm is-active"
								onclick="closePopup('programAmtPop');">확인</button>
						</div>
					</div>
				</div>
			</div>
			...
			<div class="modal-popup large" id="gangdangAmtPop">
				<div class="popup-wrap">
					...
					<div class="popup-container">
						...
						<div class="btn-area">
							<button type="button" class="btn btn-confirm is-active"
								onclick="closePopup('gangdangAmtPop');">확인</button>
						</div>
					</div>
				</div>
			</div>
			...
			<div class="modal-popup large" id="classAmtPop">
				<div class="popup-wrap">
					...
					<div class="popup-container">
						...
						<div class="btn-area">
							<button type="button" class="btn btn-confirm is-active"
								onclick="closePopup('classAmtPop');">확인</button>
						</div>
					</div>
				</div>
			</div>
					...
					<div class="popup-container">
						<div class="center" data-area-name="reservation-popup-container">
							<i class="icon-check"></i> <strong class="title-1">예약이
								완료되었습니다.</strong>
							<p class="copy-mid">
								결제 만기일시는 <em data-popup-information-eco="sttlmMtDtm"></em> 까지
								입니다.<br>미 결제시 자동 취소되니 유의 하시기 바랍니다.
							</p>
