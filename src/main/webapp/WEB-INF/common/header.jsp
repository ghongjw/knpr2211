...
<header id="header">
		...
		<ul class="gnb">
			...
			<li><a href="javascript:void(0);" class="depth1">예약하기</a>
				<ul class="depth2">
					...
					<li><a href="reservation/ecoReservation">생태탐방원</a></li>

					<li><a href="reservation/cottageReservation">민박촌</a></li>
	...
	<div class="util-area" data-device-mode="pc">
		<a href="" class="btn-refund-inquiry"> <i
			class="icon-refund-inquiry"></i> <span>미환불금조회</span>
		</a>

		<!-- 비 로그인 상태 -->
		<c:if test="${empty sessionScope.id }">
			<a href="" class="btn-login"> <i class="icon-user-check"></i> <span>로그인</span>
			</a>
			<a href="" class="btn-join" target="_blank"> <i
				class="icon-user-plus"></i> <span>회원가입</span>
			</a>
		</c:if>
		<!-- 비 로그인 상태 -->
		...
		<div class="all-menu">
			<div class="head">
				...
				<c:if test="${empty sessionScope.id }">
					...
					<a href="" class="btn-login">로그인이<br>필요합니다.
					</a>
					<a href="" class="btn-join" target="_blank"> <i
						class="icon-user-plus"></i> <span>회원가입</span>
					</a>
