...
<script>
	...
	let open_detailInfomation = function(seq,type,title,place,duration,target,people,extra){
			...
			var swipe1 = ''
				...
				for (i = 0; i <= cnt; i++) {
					swipe1 = swipe1
							...
							+ '<img src="/opt/tomcat/tomcat-9/webapps/upload/cntnts/p_'+seq+'/p'+seq+'_'+i+'.jpg"/> </div>'
				}
		...
		$(".extra").html(extra);
		$(".title_image").attr('src','/opt/tomcat/tomcat-9/webapps/upload/cntnts/p_'+seq+'/title.jpg')
		$(".schedule_image").attr('src','/opt/tomcat/tomcat-9/webapps/upload/cntnts/p_'+seq+'/schedule.jpg')
				...
				<c:forEach var = "program" items = "${sessionScope.programs }" varStatus="status" >
					<c:if test="${program.type == 'e' }">
						...
						<span class = "imgForTunbnail">
							<img src="/opt/tomcat/tomcat-9/webapps/upload/cntnts/p_${program.seq}/thumbnail.jpg" 
